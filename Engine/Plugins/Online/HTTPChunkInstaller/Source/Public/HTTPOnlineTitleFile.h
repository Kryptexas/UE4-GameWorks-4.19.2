...
public:
	...
	*/
	FOnlineTitleFileHttp(const FString& InBaseUrl, const FString& InManifestData);
...
private:
	...
	*/
	...
	bool ParseManifest(FString& ResponseStr);
	...
	*/
	...
	uint32 CompatibleClientVersion;

	FString ManifestData;
...
public:
	...
	enum class Compatible
	{
		...
		ClientIsNewerThanMcp
	};
	Compatible IsClientCompatible() const;
