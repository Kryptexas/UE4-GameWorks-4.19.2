...
public:
	...
	virtual TSharedPtr<SWidget> BuildOutlinerRightGutterWidget(const FGuid& ObjectBinding, UMovieSceneTrack* Track, const FBuildEditWidgetParams& Params) override;
