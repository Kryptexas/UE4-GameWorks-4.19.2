...
// Used by the Quadric.h computations
#define SINGULAR_QUADRIC_DET 1e-8

DEFINE_LOG_CATEGORY(LogQuadric);
//==================================================================================================
// these are from Developer/MeshSimplifier/Private/Quadric.cpp
// and hense the copywright.
...
{
	typedef TQuadricAttrOptimizer<ProxyLOD::FQuadricMeshSimplifier::NumAttributes >  OptimizerType;
};
