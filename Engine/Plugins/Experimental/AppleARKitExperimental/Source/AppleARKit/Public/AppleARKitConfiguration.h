...
// AppleARKit
#include "AppleARKitConfiguration.generated.h"
...
class APPLEARKITEXPERIMENTAL_API UAppleARKitConfiguration : public UObject
{
    GENERATED_BODY()
 ...
 */
UCLASS( Config=Game, BlueprintType, Category="AppleARKit" )
class APPLEARKITEXPERIMENTAL_API UAppleARKitWorldTrackingConfiguration : public UAppleARKitConfiguration
{
    GENERATED_BODY()
