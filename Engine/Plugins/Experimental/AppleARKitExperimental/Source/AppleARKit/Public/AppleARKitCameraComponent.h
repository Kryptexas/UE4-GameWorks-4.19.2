...
class APPLEARKITEXPERIMENTAL_API UAppleARKitCameraComponent : public UCameraComponent
{
	GENERATED_BODY()
...
private:
	...
	class FAppleARKitViewExtension : public FSceneViewExtensionBase
	{
	public:
		FAppleARKitViewExtension(const FAutoRegister&, UAppleARKitCameraComponent* InAppleARKitComponent);
