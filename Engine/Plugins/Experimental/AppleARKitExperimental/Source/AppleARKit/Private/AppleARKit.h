...
class FAppleARKitExperimentalModule : public IAppleARKitExperimentalModule
{
public:
	 ...
	 */
	static inline FAppleARKitExperimentalModule& Get()
	{
		return FModuleManager::LoadModuleChecked< FAppleARKitExperimentalModule >("AppleARKit");
	}
