...
void UAppleARKitCameraComponent::TickComponent( float DeltaTime, enum ELevelTick TickType, FActorComponentTickFunction *ThisTickFunction )
{
	...
	{
		TSharedPtr< FAppleARKitViewExtension, ESPMode::ThreadSafe > NewViewExtension(new FAppleARKitViewExtension(this));
...
UAppleARKitCameraComponent::FAppleARKitViewExtension::FAppleARKitViewExtension(UAppleARKitCameraComponent* InAppleARKitComponent)
{
