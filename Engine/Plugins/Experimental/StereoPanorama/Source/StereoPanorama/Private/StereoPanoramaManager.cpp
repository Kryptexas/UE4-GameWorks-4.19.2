...
IConsoleVariable* FStereoPanoramaManager::OutputDir                  = IConsoleManager::Get().RegisterConsoleVariable( TEXT( "SP.OutputDir" ), TEXT("F:/NeuroSP"), TEXT("Output directory"), ECVF_Default);
