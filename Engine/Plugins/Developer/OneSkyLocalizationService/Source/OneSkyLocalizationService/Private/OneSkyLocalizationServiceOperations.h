...
* Operation used to list the languages supported by a project in one sky
*/
class FOneSkyTranslationExportOperation : public ILocalizationServiceOperation
{
public:
	// ILocalizationServiceOperation interface
	virtual FName GetName() const override
	...
	virtual FText GetInProgressString() const override
	{
		return LOCTEXT("OneSkyLocalizationService_TranslationExport", "Exporting translations for a file in a project in OneSky...");
	}

	FOneSkyTranslationExportOperation() : InProjectId(-1) { }
	...
	FString GetInSourceFileName()
	{
		return InSourceFileName;
	}

	void SetInSourceFileName(FString NewSourceFileName)
	{
		InSourceFileName = NewSourceFileName;
	}

	FString GetInExportFileName()
	{
		return InExportFileName;
	}

	void SetInExportFileName(FString NewExportFileName)
	{
		InExportFileName = NewExportFileName;
	}
