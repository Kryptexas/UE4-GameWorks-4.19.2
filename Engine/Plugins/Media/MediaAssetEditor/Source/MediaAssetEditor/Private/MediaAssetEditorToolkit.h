 ...
 */
class FMediaAssetEditorToolkit
...
public:
	 ...
	 */
	FMediaAssetEditorToolkit( const TSharedRef<ISlateStyle>& InStyle );

	/**
	 * Destructor.
	 */
	virtual ~FMediaAssetEditorToolkit( );
...
public:
	 ...
	 *
	 * @param InMediaAsset The media asset to edit.
	 * @param InMode The mode to create the toolkit in.
	 * @param InToolkitHost The toolkit host.
	 */
	void Initialize( UMediaAsset* InMediaAsset, const EToolkitMode::Type InMode, const TSharedPtr<class IToolkitHost>& InToolkitHost );
