...
/**
 * Implements the player in the media asset editor.
 */
class SMediaAssetEditorPlayer
	: public SCompoundWidget
{
public:

	SLATE_BEGIN_ARGS(SMediaAssetEditorPlayer) { }
	SLATE_END_ARGS()

public:

	/** Default constructor. */
	SMediaAssetEditorPlayer( );
...
private:
	...
	TSharedPtr<FMediaAssetEditorViewport> Viewport;
};
