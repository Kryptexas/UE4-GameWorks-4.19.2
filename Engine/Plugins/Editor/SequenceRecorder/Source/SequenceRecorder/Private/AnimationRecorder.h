...
private:
	void Record(USkeletalMeshComponent* Component, FTransform const& ComponentToWorld, const TArray<FTransform>& SpacesBases, int32 FrameToAdd);
...
public:
	...
	void StopRecordingAnimation(USkeletalMeshComponent* Component);
