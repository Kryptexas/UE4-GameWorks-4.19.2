...
FTangoVideoOverlayRendererRHI::FTangoVideoOverlayRendererRHI()
	: bInitialized(false)
...
void FTangoVideoOverlayRendererRHI::SetDefaultCameraOverlayMaterial(UMaterialInterface* InDefaultCameraOverlayMaterial)
{
	DefaultOverlayMaterial = InDefaultCameraOverlayMaterial;
}

void FTangoVideoOverlayRendererRHI::InitializeOverlayMaterial()
{
...
void FTangoVideoOverlayRendererRHI::SetOverlayMaterialInstance(UMaterialInterface* NewMaterialInstance)
{
	if (NewMaterialInstance != nullptr)
	{
        ...
        FTangoVideoOverlayRendererRHI*, VideoOverlayRendererRHIPtr, this,
        {
...
void FTangoVideoOverlayRendererRHI::ResetOverlayMaterialToDefault()
{
...
void FTangoVideoOverlayRendererRHI::InitializeIndexBuffer_RenderThread()
{
	if (bInitialized)
		return;
...
uint32 FTangoVideoOverlayRendererRHI::AllocateVideoTexture_RenderThread()
{
#if PLATFORM_ANDROID
	if (VideoTexture == nullptr)
	{
		...
		FExternalTextureRegistry::Get().RegisterExternalTexture(TangoPassthroughCameraExternalTextureGuid, VideoTexture, SamplerStateRHI);
	}
...
void FTangoVideoOverlayRendererRHI::UpdateOverlayUVCoordinate_RenderThread(TArray<float>& InOverlayUVs)
{
...
void FTangoVideoOverlayRendererRHI::CopyVideoTexture_RenderThread(FRHICommandListImmediate& RHICmdList, FTextureRHIParamRef DstTexture, FIntPoint TargetSize)
{
#if PLATFORM_ANDROID
