...
*/
class IResonanceAudioModule : public IModuleInterface
{
public:
	/**
	...
	*/
	static inline IResonanceAudioModule& Get()
	{
		return FModuleManager::LoadModuleChecked<IResonanceAudioModule>("ResonanceAudioModule");
	}
	...
	*/
	...
	{
		return FModuleManager::Get().IsModuleLoaded("ResonanceAudioModule");
	}
};
