...
namespace Audio
{
	...
	public:
		...
		void SetEnvModPatch(const ESynthEnvModPatch InPatchType);
	...
	protected:
		...
		FPatch ModEnvPatches[(int32)ESynthEnvModPatch::Count];

		TMap<int32, TSharedPtr<FPatch>> DynamicPatches;

		ESynthLFOPatchType CurrentPatchType[NumLFOs];
		ESynthEnvModPatch CurrentModPatchType;
	...
	protected:
		...
		bool bIsModulatingLFOFromLFO : 1;
		bool bIsModualtingLFOFromModEnv : 1;
		bool bIsUnison : 1;
