...
void UEpicSynth1Component::SetLFOPatch(int32 LFOIndex, ESynthLFOPatchType LFOPatchType)
{
	...
	{
		EpicSynth1.SetLFOPatch(LFOIndex, (Audio::ELFOPatch::Type)LFOPatchType);
	});
}
...
{
	Audio::EFilterAlgorithm::Type AlgorithmType = Audio::EFilterAlgorithm::StateVariable;
	if (FilterAlgorithm == ESynthFilterAlgorithm::Ladder)
	{
		AlgorithmType = Audio::EFilterAlgorithm::Ladder;
	}

	SynthCommand([this, AlgorithmType]()
	{
		EpicSynth1.SetFilterAlgorithm(AlgorithmType);
	});
}
...
void UEpicSynth1Component::SetSynthPreset(const FEpicSynth1Preset& SynthPreset)
{
	SynthCommand([this, SynthPreset]()
	{
		...
		EpicSynth1.SetLFOPatch(0, (Audio::ELFOPatch::Type)SynthPreset.LFO1PatchType);
		...
		EpicSynth1.SetLFOPatch(1, (Audio::ELFOPatch::Type)SynthPreset.LFO2PatchType);
		...
		Audio::EFilterAlgorithm::Type AlgorithmType = Audio::EFilterAlgorithm::StateVariable;
		if (SynthPreset.FilterAlgorithm == ESynthFilterAlgorithm::Ladder)
		{
			AlgorithmType = Audio::EFilterAlgorithm::Ladder;
		}
