...
extern "C" void Java_com_epicgames_ue4_AmazonStoreHelper_nativeQueryComplete(JNIEnv* jenv, jobject thiz, jboolean bSuccess, jobjectArray productIDs, jobjectArray titles, jobjectArray descriptions, jobjectArray prices)
{
...
void FOnlineStoreGameCircle::ProcessQueryAvailablePurchasesResults(bool bInSuccessful, const TArray<FInAppPurchaseProductInfo>& AvailablePurchases)
{
	...
	TriggerOnQueryForAvailablePurchasesCompleteDelegates(bInSuccessful);
}
...
extern "C" void Java_com_epicgames_ue4_AmazonStoreHelper_nativePurchaseComplete(JNIEnv* jenv, jobject thiz, jboolean bSuccess, jstring productId, jstring receiptData, jstring signature)
{
...
void FOnlineStoreGameCircle::ProcessPurchaseResult(bool bInSuccessful, const FString& ProductId, const FString& InReceiptData, const FString& Signature)
{
...
extern "C" void Java_com_epicgames_ue4_AmazonStoreHelper_nativeRestorePurchasesComplete(JNIEnv* jenv, jobject thiz, jboolean bSuccess, jobjectArray ProductIDs, jobjectArray ReceiptsData)
{
