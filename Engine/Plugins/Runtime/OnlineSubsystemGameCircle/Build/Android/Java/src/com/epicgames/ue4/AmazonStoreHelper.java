...
public class AmazonStoreHelper implements StoreHelper, PurchasingListener
{
		...
		case SUCCESSFUL:
			{
				...
				nativeQueryComplete(true, ProductSkus.toArray(new String[ProductSkus.size()]), titles.toArray(new String[titles.size()]), descriptions.toArray(new String[descriptions.size()]), prices.toArray(new String[prices.size()]));
			}
			break;
		case FAILED:
	...
	public void onPurchaseResponse(PurchaseResponse purchaseResponse)
	{
		...
		case SUCCESSFUL:
			{
				...
				nativePurchaseComplete(true, receipt.getSku(), receipt.toJSON().toString(), receipt.getReceiptId());
		...
		case FAILED:
			...
			nativePurchaseComplete(false, null, null, null);
			break;
		case NOT_SUPPORTED:
	...
	public void onPurchaseUpdatesResponse(PurchaseUpdatesResponse purchaseUpdatesResponse)
	{
		...
		case SUCCESSFUL:
			...
			else
			{
				...
				nativeRestorePurchasesComplete( true, restoreSkus.toArray( new String[restoreSkus.size()] ), restoreReceiptData.toArray( new String[restoreReceiptData.size()] ) );
