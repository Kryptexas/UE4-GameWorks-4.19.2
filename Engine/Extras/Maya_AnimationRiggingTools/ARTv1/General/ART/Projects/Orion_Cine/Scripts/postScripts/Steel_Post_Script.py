...
def rigArms():
    ...
    for side in ["_l", "_r"]:
        ...
        cmds.setDrivenKeyframe(["bicep_straps_geo_blendShape.bicep_straps_geo_shoulders_up"+side, "shoulders_geo_blendShape.shoulders_geo_shoulders_up"+side], cd="upperarm"+side+".rotateY", itt="flat", ott="flat")
        cmds.setDrivenKeyframe(["bicep_straps_geo_blendShape.bicep_straps_geo_shoulders_down"+side, "shoulders_geo_blendShape.shoulders_geo_shoulders_down"+side], cd="upperarm"+side+".rotateY", itt="flat", ott="flat")

        cmds.setAttr("fk_arm"+side+"_anim.ry", 0)
        cmds.setAttr("bicep_straps_geo_blendShape.bicep_straps_geo_shoulders_up"+side, 1)
        cmds.setAttr("shoulders_geo_blendShape.shoulders_geo_shoulders_up"+side, 1)
        cmds.setDrivenKeyframe(["bicep_straps_geo_blendShape.bicep_straps_geo_shoulders_up"+side, "shoulders_geo_blendShape.shoulders_geo_shoulders_up"+side], cd="upperarm"+side+".rotateY", itt="flat", ott="flat")
        cmds.setDrivenKeyframe(["bicep_straps_geo_blendShape.bicep_straps_geo_shoulders_down"+side, "shoulders_geo_blendShape.shoulders_geo_shoulders_down"+side], cd="upperarm"+side+".rotateY", itt="flat", ott="flat")
        cmds.setAttr("bicep_straps_geo_blendShape.bicep_straps_geo_shoulders_up"+side, 0)
        cmds.setAttr("shoulders_geo_blendShape.shoulders_geo_shoulders_up"+side, 0)

        cmds.setAttr("fk_arm"+side+"_anim.ry", 82)
        cmds.setAttr("bicep_straps_geo_blendShape.bicep_straps_geo_shoulders_down"+side, 1)
        cmds.setAttr("shoulders_geo_blendShape.shoulders_geo_shoulders_down"+side, 1)
        cmds.setDrivenKeyframe(["bicep_straps_geo_blendShape.bicep_straps_geo_shoulders_up"+side, "shoulders_geo_blendShape.shoulders_geo_shoulders_up"+side], cd="upperarm"+side+".rotateY", itt="flat", ott="flat")
        cmds.setDrivenKeyframe(["bicep_straps_geo_blendShape.bicep_straps_geo_shoulders_down"+side, "shoulders_geo_blendShape.shoulders_geo_shoulders_down"+side], cd="upperarm"+side+".rotateY", itt="flat", ott="flat")
        cmds.setAttr("bicep_straps_geo_blendShape.bicep_straps_geo_shoulders_down"+side, 0)
        ...
        cmds.setAttr("bicep_straps_geo_blendShape.bicep_straps_geo_elbows_bent"+side, 0)
        cmds.setAttr("shoulders_geo_blendShape.shoulders_geo_elbows_bent"+side, 0)
        cmds.setDrivenKeyframe(["bicep_straps_geo_blendShape.bicep_straps_geo_elbows_bent"+side, "shoulders_geo_blendShape.shoulders_geo_elbows_bent"+side], cd="lowerarm"+side+".rotateZ", itt="flat", ott="flat")
        
        cmds.setAttr("fk_elbow"+side+"_anim.rz", -100)
        cmds.setAttr("bicep_straps_geo_blendShape.bicep_straps_geo_elbows_bent"+side, 1)
...
#BEGIN JERNST CINE BLOCK
#create the foot armor rig (left)
cmds.createNode("joint", name = "l_foot_top_armor")
cmds.createNode("joint", name = "l_foot_top_armor_end")

cmds.xform("l_foot_top_armor", ws = True, rotation = [-90, 35.4419, -90], t = [27.52, -6.1206, 25.20597])
cmds.xform("l_foot_top_armor_end", ws = True, rotation = [-90, 22.5059, -90], t = [27.52, -16.97217, 17.4694])
cmds.parent("l_foot_top_armor_end", "l_foot_top_armor")
cmds.parent("l_foot_top_armor", "calf_l")
cmds.makeIdentity("l_foot_top_armor", t = 0 , r = 1, s = 0, apply = True)

lFootArmorIK = cmds.ikHandle(sj = "l_foot_top_armor", ee = "l_foot_top_armor_end", sol = "ikSCsolver")


#create the toe armor rig (left)
cmds.createNode("joint", name = "l_foot_toe_armor")
cmds.createNode("joint", name = "l_foot_toe_armor_end")


cmds.xform("l_foot_toe_armor", ws = True, rotation = [-90, 22.5059, -90], t = [27.52, -12.9240, 19.26320])
cmds.xform("l_foot_toe_armor_end", ws = True, rotation = [-90, 22.5059, -90], t = [27.52, -22.5982, 15.25484])
cmds.parent("l_foot_toe_armor_end", "l_foot_toe_armor")
cmds.parent("l_foot_toe_armor", "foot_l")
cmds.makeIdentity("l_foot_toe_armor", t = 0 , r = 1, s = 0, apply = True)

lToeArmorIK = cmds.ikHandle(sj = "l_foot_toe_armor", ee = "l_foot_toe_armor_end", sol = "ikSCsolver")

#parent IK handles (left)
cmds.parent(lFootArmorIK[0], "l_foot_toe_armor")
cmds.parent(lToeArmorIK[0], "ball_l")

#create the foot armor rig (right)
cmds.createNode("joint", name = "r_foot_top_armor")
cmds.createNode("joint", name = "r_foot_top_armor_end")

cmds.xform("r_foot_top_armor", ws = True, rotation = [-90, 35.4419, -90], t = [-27.52, -6.1206, 25.20597])
cmds.xform("r_foot_top_armor_end", ws = True, rotation = [-90, 22.5059, -90], t = [-27.52, -16.97217, 17.4694])
cmds.parent("r_foot_top_armor_end", "r_foot_top_armor")
cmds.parent("r_foot_top_armor", "calf_r")
cmds.makeIdentity("r_foot_top_armor", t = 0 , r = 1, s = 0, apply = True)

lFootArmorIK = cmds.ikHandle(sj = "r_foot_top_armor", ee = "r_foot_top_armor_end", sol = "ikSCsolver")


#create the toe armor rig (right)
cmds.createNode("joint", name = "r_foot_toe_armor")
cmds.createNode("joint", name = "r_foot_toe_armor_end")


cmds.xform("r_foot_toe_armor", ws = True, rotation = [-90, 22.5059, -90], t = [-27.52, -12.9240, 19.26320])
cmds.xform("r_foot_toe_armor_end", ws = True, rotation = [-90, 22.5059, -90], t = [-27.52, -22.5982, 15.25484])
cmds.parent("r_foot_toe_armor_end", "r_foot_toe_armor")
cmds.parent("r_foot_toe_armor", "foot_r")
cmds.makeIdentity("r_foot_toe_armor", t = 0 , r = 1, s = 0, apply = True)

lToeArmorIK = cmds.ikHandle(sj = "r_foot_toe_armor", ee = "r_foot_toe_armor_end", sol = "ikSCsolver")

#parent IK handles (right)
cmds.parent(lFootArmorIK[0], "r_foot_toe_armor")
cmds.parent(lToeArmorIK[0], "ball_r")


#Add joints to skinClusters
skinClusters = cmds.ls(type = "skinCluster")

for cluster in skinClusters:
    geo = cmds.skinCluster(cluster, q = True, geometry = True)[0]
    if geo == "boot_cover_geoShape":
        cmds.skinCluster(cluster, edit = True, dr = 4, lw = True, wt = 0, ai = ["l_foot_top_armor", "l_foot_top_armor_end", "r_foot_top_armor", "r_foot_top_armor_end"])
        
        cmds.skinPercent(cluster, "boot_cover_geo.vtx[0:123]", tv = ["l_foot_top_armor", 1])
        cmds.skinPercent(cluster, "boot_cover_geo.vtx[124:247]", tv = ["r_foot_top_armor", 1])
        
        
    if geo == "toe_plates_geoShape":
        cmds.skinCluster(cluster, edit = True, dr = 4, lw = True, wt = 0, ai = ["l_foot_toe_armor", "l_foot_toe_armor_end", "r_foot_toe_armor", "r_foot_toe_armor_end"])
        
        cmds.skinPercent(cluster, "toe_plates_geo.vtx[0:185]", tv = ["l_foot_toe_armor", 1])
        cmds.skinPercent(cluster, "toe_plates_geo.vtx[186:371]", tv = ["r_foot_toe_armor", 1])
# END JERNST CINE BLOCK
