...
def scaleControls():
    ...
    for side in sides:
        ...
        if side is "_l":
            cmds.move(0, -5, 0, r = True, os=True)
        else:
            cmds.move(0, 5, 0, r = True, os=True)
