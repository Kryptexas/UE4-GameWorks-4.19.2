...
# ------------------------------------------------------------------
def shoulderPadRig():
    shoulderpad_l_anim_drv = cmds.group("shoulderpad_l_anim", name="shoulderpad_l_anim_drv")
    cmds.aimConstraint("driver_upperarm_l", shoulderpad_l_anim_drv, aimVector = [1, 0, 0], upVector = [0, 0, 1], worldUpType="objectrotation", worldUpVector=[0, 1, 0], worldUpObject="driver_clavicle_l", mo=True, skip = ["x", "z"])
    cmds.transformLimits("shoulderpad_l_anim_drv", ry=[0, 1.92], ery=[0, 1])
    
    shoulderpad_r_anim_drv = cmds.group("shoulderpad_r_anim", name="shoulderpad_r_anim_drv")
    cmds.aimConstraint("driver_upperarm_r", shoulderpad_r_anim_drv, aimVector = [-1, 0, 0], upVector = [0, 0, -1], worldUpType="objectrotation", worldUpVector=[0, 1, 0], worldUpObject="driver_clavicle_r", mo=True, skip = ["x", "z"])
    cmds.transformLimits("shoulderpad_r_anim_drv", ry=[0, 1.92], ery=[0, 1])

    shoulderblade_l_anim_drv = cmds.group("shoulderblade_l_anim", name="shoulderblade_l_anim_drv")
    cmds.aimConstraint("driver_upperarm_l", shoulderblade_l_anim_drv, aimVector = [1, 0, 0], upVector = [0, 0, 1], worldUpType="objectrotation", worldUpVector=[0, 1, 0], worldUpObject="driver_clavicle_l", mo=True, skip = ["x", "z"])
    cmds.transformLimits("shoulderblade_l_anim_drv", ry=[0, 1.92], ery=[0, 1])
    
    shoulderblade_r_anim_drv = cmds.group("shoulderblade_r_anim", name="shoulderblade_r_anim_drv")
    cmds.aimConstraint("driver_upperarm_r", shoulderblade_r_anim_drv, aimVector = [-1, 0, 0], upVector = [0, 0, -1], worldUpType="objectrotation", worldUpVector=[0, 1, 0], worldUpObject="driver_clavicle_r", mo=True, skip = ["x", "z"])
    cmds.transformLimits("shoulderblade_r_anim_drv", ry=[0, 1.92], ery=[0, 1])
