...
def scaleControls():
    ...
    objects = ["hair_top_anim", "fk_ponytail_01_anim", "fk_ponytail_02_anim", "fk_ponytail_03_anim", "fk_ponytail_04_anim", "quiver_anim", "arrow_nock_anim", "bow_base_anim", "bow_shaft_top_01_anim", "bow_shaft_top_02_anim", "bow_shaft_top_03_anim", "bow_shaft_bott_01_anim", "bow_shaft_bott_02_anim", "bow_shaft_bott_03_anim", "bow_string_bott_anim", "bow_string_mid_anim", "bow_string_top_anim", "front_strap_small_anim", "fk_front_strap_01_anim", "fk_front_strap_02_anim", "fk_skirt_back_cloth_01_anim", "fk_skirt_back_cloth_02_anim", "fk_skirt_cloth_l_01_anim", "fk_skirt_cloth_l_02_anim", "fk_skirt_front_cloth_01_anim", "fk_skirt_front_cloth_02_anim", "breast_chain_anim", "feathers_anim", "hair_curls_A_l_01_anim", "hair_curls_A_r_01_anim", "hair_curls_B_l_01_anim", "hair_curls_B_l_01_anim", "fk_chest_cloth_l_01_anim", "fk_chest_cloth_l_02_anim", "fk_chest_cloth_r_01_anim", "fk_chest_cloth_r_02_anim", "fk_back_tail_cloth_01_anim", "fk_back_tail_cloth_02_anim", "brooch_front_l_anim", "brooch_front_r_anim", "brooch_back_l_anim", "brooch_back_r_anim"]
    for one in objects:
        cmds.select([one+".cv[*]"])
...
def bowAndArrowRig():
    ...
    # Create a dummy node that represents the original position of the arrow string.
    bow_string_mid_anim_WORLD = cmds.duplicate("bow_string_mid_anim", n="bow_string_mid_anim_WORLD", po=True)[0]
    cmds.parent(bow_string_mid_anim_WORLD, "bow_string_mid_parent_grp")
    cmds.parentConstraint("bow_string_mid_anim", bow_string_mid_anim_WORLD, mo=True)

    bowshaftDict = {"bow_shaft_top_01_anim_grp":-10, "bow_shaft_top_02_anim_grp":-14, "bow_shaft_top_03_anim_grp":-19.4, "bow_shaft_bott_01_anim_grp":-10, "bow_shaft_bott_02_anim_grp":-14, "bow_shaft_bott_03_anim_grp":-19.4}
    for one in bowshaftDict:
        mdNode = cmds.shadingNode("multiplyDivide", asUtility=True, name=one+"_mdNode")
        clampNode = cmds.shadingNode("clamp", asUtility=True, name=one+"_clampNode")
        remapValueNode = cmds.shadingNode("remapValue", asUtility=True, name=one+"_remapValueNode")

        cmds.connectAttr(bow_string_mid_anim_WORLD+".translateY", clampNode+".inputR", f=True)
        cmds.connectAttr(clampNode+".outputR", mdNode+".input1X", f=True)
        cmds.connectAttr(mdNode+".outputX", remapValueNode+".inputValue", f=True)
        cmds.connectAttr(remapValueNode+".outValue", one+".rotateX", f=True)
        cmds.setAttr(mdNode+".input2X", -1)
        cmds.setAttr(clampNode+".maxR", 120)
        cmds.setAttr(remapValueNode+".value[1].value_Position", -120)
        cmds.setAttr(remapValueNode+".value[1].value_FloatValue", bowshaftDict[one])
...
# ------------------------------------------------------------------
def broochRig():
    # Create SDK's for the brooch.
    cmds.setDrivenKeyframe(["brooch_front_l_anim_grp.rx", "brooch_back_l_anim_grp.rx", "brooch_front_l_anim_grp.rz", "brooch_back_l_anim_grp.rz"], cd = "driver_clavicle_l.rz", itt = "spline", ott = "spline")
    cmds.setAttr("clavicle_l_anim.ty", -25)
    cmds.setAttr("brooch_front_l_anim_grp.rz", -43.5)
    cmds.setAttr("brooch_back_l_anim_grp.rz", -20.8)
    cmds.setDrivenKeyframe(["brooch_front_l_anim_grp.rx", "brooch_back_l_anim_grp.rx", "brooch_front_l_anim_grp.rz", "brooch_back_l_anim_grp.rz"], cd = "driver_clavicle_l.rz", itt = "spline", ott = "spline")

    cmds.setAttr("clavicle_l_anim.ty", -7)
    cmds.setAttr("brooch_front_l_anim_grp.rx", 0.17028)
    cmds.setAttr("brooch_front_l_anim_grp.rz", -6.47505)
    cmds.setAttr("brooch_back_l_anim_grp.rx", 1.06856)
    cmds.setAttr("brooch_back_l_anim_grp.rz", -6.61083)
    cmds.setDrivenKeyframe(["brooch_front_l_anim_grp.rx", "brooch_back_l_anim_grp.rx", "brooch_front_l_anim_grp.rz", "brooch_back_l_anim_grp.rz"], cd = "driver_clavicle_l.rz", itt = "spline", ott = "spline")

    cmds.setAttr("clavicle_l_anim.ty", 18.0)
    cmds.setAttr("brooch_front_l_anim_grp.rx", -2.3)
    cmds.setAttr("brooch_front_l_anim_grp.rz", 8.4)
    cmds.setAttr("brooch_back_l_anim_grp.rx", -14.1)
    cmds.setAttr("brooch_back_l_anim_grp.rz", 29.7)
    cmds.setDrivenKeyframe(["brooch_front_l_anim_grp.rx", "brooch_back_l_anim_grp.rx", "brooch_front_l_anim_grp.rz", "brooch_back_l_anim_grp.rz"], cd = "driver_clavicle_l.rz", itt = "spline", ott = "spline")

    cmds.setAttr("clavicle_l_anim.ty", 2.0)
    cmds.setAttr("brooch_front_l_anim_grp.rx", -3.47122)
    cmds.setAttr("brooch_front_l_anim_grp.rz", 3.23346)
    cmds.setAttr("brooch_back_l_anim_grp.rx", -1.9647)
    cmds.setAttr("brooch_back_l_anim_grp.rz", 9.7907)
    cmds.setDrivenKeyframe(["brooch_front_l_anim_grp.rx", "brooch_back_l_anim_grp.rx", "brooch_front_l_anim_grp.rz", "brooch_back_l_anim_grp.rz"], cd = "driver_clavicle_l.rz", itt = "spline", ott = "spline")

    cmds.setAttr("clavicle_l_anim.ty", 0)
    #---
    cmds.setDrivenKeyframe(["brooch_front_r_anim_grp.rx", "brooch_back_r_anim_grp.rx", "brooch_front_r_anim_grp.rz", "brooch_back_r_anim_grp.rz"], cd = "driver_clavicle_r.rz", itt = "spline", ott = "spline")
    cmds.setAttr("clavicle_r_anim.ty", -25)
    cmds.setAttr("brooch_front_r_anim_grp.rz", -43.5)
    cmds.setAttr("brooch_back_r_anim_grp.rz", -20.8)
    cmds.setDrivenKeyframe(["brooch_front_r_anim_grp.rx", "brooch_back_r_anim_grp.rx", "brooch_front_r_anim_grp.rz", "brooch_back_r_anim_grp.rz"], cd = "driver_clavicle_r.rz", itt = "spline", ott = "spline")

    cmds.setAttr("clavicle_r_anim.ty", -7)
    cmds.setAttr("brooch_front_r_anim_grp.rx", 0.17028)
    cmds.setAttr("brooch_front_r_anim_grp.rz", -6.47505)
    cmds.setAttr("brooch_back_r_anim_grp.rx", 1.06856)
    cmds.setAttr("brooch_back_r_anim_grp.rz", -6.61083)
    cmds.setDrivenKeyframe(["brooch_front_r_anim_grp.rx", "brooch_back_r_anim_grp.rx", "brooch_front_r_anim_grp.rz", "brooch_back_r_anim_grp.rz"], cd = "driver_clavicle_r.rz", itt = "spline", ott = "spline")

    cmds.setAttr("clavicle_r_anim.ty", 18.0)
    cmds.setAttr("brooch_front_r_anim_grp.rx", -2.3)
    cmds.setAttr("brooch_front_r_anim_grp.rz", 8.4)
    cmds.setAttr("brooch_back_r_anim_grp.rx", -14.1)
    cmds.setAttr("brooch_back_r_anim_grp.rz", 29.7)
    cmds.setDrivenKeyframe(["brooch_front_r_anim_grp.rx", "brooch_back_r_anim_grp.rx", "brooch_front_r_anim_grp.rz", "brooch_back_r_anim_grp.rz"], cd = "driver_clavicle_r.rz", itt = "spline", ott = "spline")

    cmds.setAttr("clavicle_r_anim.ty", 2.0)
    cmds.setAttr("brooch_front_r_anim_grp.rx", -3.47122)
    cmds.setAttr("brooch_front_r_anim_grp.rz", 3.23346)
    cmds.setAttr("brooch_back_r_anim_grp.rx", -1.9647)
    cmds.setAttr("brooch_back_r_anim_grp.rz", 9.7907)
    cmds.setDrivenKeyframe(["brooch_front_r_anim_grp.rx", "brooch_back_r_anim_grp.rx", "brooch_front_r_anim_grp.rz", "brooch_back_r_anim_grp.rz"], cd = "driver_clavicle_r.rz", itt = "spline", ott = "spline")

    cmds.setAttr("clavicle_r_anim.ty", 0)    
...
# ------------------------------------------------------------------
def dynamicsOff():
    for one in ["back_tail_cloth_dyn_anim", "chest_cloth_l_dyn_anim", "chest_cloth_r_dyn_anim", "front_strap_dyn_anim", "ponytail_dyn_anim", "skirt_back_cloth_dyn_anim", "skirt_cloth_l_dyn_anim", "skirt_front_cloth_dyn_anim"]:
