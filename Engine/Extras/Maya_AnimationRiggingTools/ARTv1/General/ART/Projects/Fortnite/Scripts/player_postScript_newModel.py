...
cmds.move(0.0, moveZ=True, ws = True, wd = False)
...
#unlock and show twist scale control channels
cmds.setAttr( 'upperarm_l_twist_anim.scale', lock=False, keyable=True )
cmds.setAttr( 'upperarm_l_twist_2_anim.scale', lock=False, keyable=True )
cmds.setAttr( 'upperarm_r_twist_anim.scale', lock=False, keyable=True )
cmds.setAttr( 'upperarm_r_twist_2_anim.scale', lock=False, keyable=True )

cmds.setAttr( 'lowerarm_l_twist_anim.scaleY', lock=False, keyable=True )
cmds.setAttr( 'lowerarm_l_twist2_anim.scaleY', lock=False, keyable=True )
cmds.setAttr( 'lowerarm_r_twist_anim.scaleY', lock=False, keyable=True )
cmds.setAttr( 'lowerarm_r_twist2_anim.scaleY', lock=False, keyable=True )
cmds.setAttr( 'lowerarm_l_twist_anim.scaleZ', lock=False, keyable=True )
cmds.setAttr( 'lowerarm_l_twist2_anim.scaleZ', lock=False, keyable=True )
cmds.setAttr( 'lowerarm_r_twist_anim.scaleZ', lock=False, keyable=True )
cmds.setAttr( 'lowerarm_r_twist2_anim.scaleZ', lock=False, keyable=True )

#connent scale ctrl for animators
cmds.connectAttr("upperarm_l_twist_anim.scale", "driver_upperarm_twist_01_l.scale")
cmds.connectAttr("upperarm_l_twist_2_anim.scale", "driver_upperarm_twist_02_l.scale")
cmds.connectAttr("upperarm_r_twist_anim.scale", "driver_upperarm_twist_01_r.scale")
cmds.connectAttr("upperarm_r_twist_2_anim.scale", "driver_upperarm_twist_02_r.scale")


cmds.connectAttr("lowerarm_l_twist_anim.scale", "driver_lowerarm_twist_01_l.scale")
cmds.connectAttr("lowerarm_l_twist2_anim.scale", "driver_lowerarm_twist_02_l.scale")
cmds.connectAttr("lowerarm_r_twist_anim.scale", "driver_lowerarm_twist_01_r.scale")
cmds.connectAttr("lowerarm_r_twist2_anim.scale", "driver_lowerarm_twist_02_r.scale")
