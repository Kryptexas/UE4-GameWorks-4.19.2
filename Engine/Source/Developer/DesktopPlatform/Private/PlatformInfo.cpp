...
static const FPlatformInfo PlatformInfoArray[] = {
	...
	BuildPlatformInfo(TEXT("Wolf"),						TEXT("Wolf"),				LOCTEXT("Wolf", "Wolf"),									EPlatformType::Game,		EPlatformFlags::None,			FPlatformIconPaths(TEXT("Launcher/WolfTarget/Platform_Wolf_24x"), TEXT("Launcher/WolfTarget/Platform_Wolf_128x")),						TEXT("-targetplatform=WolfPlat"),												TEXT(""),			EPlatformSDKStatus::Unknown,	TEXT(""),																								IsAvailableOnWindows,						TEXT("Wolf"),		false,					true),
};
