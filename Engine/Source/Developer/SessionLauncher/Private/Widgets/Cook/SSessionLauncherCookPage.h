...
/*=============================================================================
	SSessionLauncherCookPage.h: Declares the SSessionLauncherCookPage class.
=============================================================================*/
 ...
 */
class SSessionLauncherCookPage
	: public SCompoundWidget
{
public:

	SLATE_BEGIN_ARGS(SSessionLauncherCookPage) { }
	SLATE_END_ARGS()
