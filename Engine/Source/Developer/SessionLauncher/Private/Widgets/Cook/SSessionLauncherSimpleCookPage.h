...
/*=============================================================================
	SSessionLauncherSimpleCookPage.h: Declares the SSessionLauncherSimpleCookPage class.
=============================================================================*/
 ...
 */
class SSessionLauncherSimpleCookPage
	: public SCompoundWidget
{
public:

	SLATE_BEGIN_ARGS(SSessionLauncherSimpleCookPage) { }
	SLATE_END_ARGS()
...
public:
	 ...
	 * Destructor.
	 */
	~SSessionLauncherSimpleCookPage( );
