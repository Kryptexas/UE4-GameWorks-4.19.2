		...
		[
			...
			[
				...
				[
					...
					.IsChecked( CurrentList == EFriendsDisplayLists::DefaultDisplay ? ESlateCheckBoxState::Checked : ESlateCheckBoxState::Unchecked )
				...
				[
					...
					.Style( &FriendStyle.CheckBoxToggleStyle )
					.Type( ESlateCheckBoxType::ToggleButton )
					.IsChecked(CurrentList == EFriendsDisplayLists::RecentPlayersDisplay ? ESlateCheckBoxState::Checked : ESlateCheckBoxState::Unchecked )
				...
				[
					...
					.Style( &FriendStyle.CheckBoxToggleStyle )
					.Type( ESlateCheckBoxType::ToggleButton )
					.IsChecked(CurrentList == EFriendsDisplayLists::FriendRequestsDisplay ? ESlateCheckBoxState::Checked : ESlateCheckBoxState::Unchecked )
