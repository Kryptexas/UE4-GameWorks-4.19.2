					...
					[
						...
						[
							...
							[
								...
								[
									SNew(STextBlock)
									.Font(FriendFontStyle.FriendsFontNormalBold)
									.ColorAndOpacity(FriendFontStyle.DefaultFontColor)
...
private:
	...
	TSharedPtr<SToolTip> CreateJoingGameToolTip()
	{
		if(!ViewModel->CanPerformAction(EFriendActionType::JoinGame))
		{
			...
			.BackgroundImage(&FriendStyle.Background);
		}
		return nullptr;
	}
...
private:
	...
	FFriendsFontStyle FriendFontStyle;
