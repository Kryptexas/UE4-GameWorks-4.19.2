...
public:
	...
	void Construct(const FArguments& InArgs, const TSharedRef<FFriendsViewModel>& InViewModel)
	{
		...
		[
			...
			[
				SNew(SBorder)
				.Padding(FriendListStyle.UserHeaderPadding)
				.BorderImage(&FriendListStyle.FriendUserHeaderBackground)
				.Visibility(FriendListStyle.HasUserHeader ? EVisibility::Visible : EVisibility::Collapsed)
				[
					SNew(SBox)
					.WidthOverride(FriendListStyle.FriendsListWidth)
					[
						SNew(SHorizontalBox)
						+SHorizontalBox::Slot()
						.AutoWidth()
			...
			[
				...
				[
					...
					[
						...
						.ButtonStyle(&FriendListStyle.GlobalChatButtonStyle)
...
private:
	...
	TSharedPtr<SToolTip> CreateAddFriendToolTip()
	{
		...
		.BackgroundImage(&FriendListStyle.Background);
	}
	...
	TSharedRef<SWidget> GetFriendsListWidget()
	{
		...
		return SNew(SVerticalBox)
			...
			[
				...
				.BorderImage(&FriendListStyle.FriendContainerHeader)
				[
					SNew(SBox)
					.WidthOverride(FriendListStyle.FriendsListWidth)
//							.HeightOverride(FriendStyle.FriendItemHeight)
					[
						SNew(SHorizontalBox)
						+ SHorizontalBox::Slot()
						.VAlign(VAlign_Center)
							...
							[
								...
								[
									...
									[
										...
										.HAlign(HAlign_Center)
										.VAlign(VAlign_Center)
										.WidthOverride(FriendListStyle.AddFriendButtonSize.Y)
										.HeightOverride(FriendListStyle.AddFriendButtonSize.Y)
										[
											SNew(SImage)
						...
						[
							SNew(SButton)
							.ButtonStyle(&FriendListStyle.AddFriendCloseButtonStyle)
			...
			[
				SNew(SBorder)
				.BorderImage(&FriendListStyle.FriendsContainerBackground)
				.Padding(0)
				[
					SNew(SOverlay)
					+ SOverlay::Slot()
...
//	return Switcher->GetActiveWidgetIndex() == WidgetIndex ?  FriendStyle.DefaultFontColor : FriendStyle.FriendListActionFontColor;
	return Switcher->GetActiveWidgetIndex() == WidgetIndex ?  FLinearColor::White : FLinearColor::Gray;
}
...
private:
	...
	FFriendsListStyle FriendListStyle;
