...
const FButtonStyle* SFriendsList::GetActionButtonStyle(const FFriendsListStyle& FriendStyle, EFriendActionLevel ActionLevel)
{
	switch (ActionLevel)
	{
...
FSlateColor SFriendsList::GetActionButtonFontColor(const FFriendsListStyle& FriendStyle, EFriendActionLevel ActionLevel)
{
	switch (ActionLevel)
	{
	case EFriendActionLevel::Critical:
