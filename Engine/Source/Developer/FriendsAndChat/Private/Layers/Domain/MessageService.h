 ...
 */
FACTORY(TSharedRef< FMessageService >, FMessageService, const TSharedRef<class FOSSScheduler>& OSSScheduler, const TSharedRef<class FFriendsService>& FriendsService);
