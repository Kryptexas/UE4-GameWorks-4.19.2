...
public:
	...
	static TSharedRef< FTimeStampRun > Create(const TSharedRef<class FTextLayout>& TextLayout, const FRunInfo& InRunInfo, const TSharedRef< const FString >& InText, const FTimeStampRunInfo& InWidgetInfo);
...
private:
	...
	FTimeStampRun(const TSharedRef<class FTextLayout>& TextLayout, const FRunInfo& InRunInfo, const TSharedRef< const FString >& InText, const FTimeStampRunInfo& InWidgetInfo);

	FTimeStampRun( const FTimeStampRun& Run );
...
private:
	...
	TSharedPtr<SWidget> TimeStampWidget;
