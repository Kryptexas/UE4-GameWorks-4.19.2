...
class FShaderFormatGLSL : public IShaderFormat
{
	enum
	{
		...
		UE_SHADER_GLSL_150_VER = 64,
		UE_SHADER_GLSL_430_VER = 64,
		UE_SHADER_GLSL_ES2_VER = 64,
		UE_SHADER_GLSL_150ES2_VER = 64,
		UE_SHADER_GLSL_150ES2NOUB_VER = 64,
		UE_SHADER_GLSL_150ES3_1_VER = 64,
		UE_SHADER_GLSL_ES2_VER_WEBGL = 64,
		UE_SHADER_GLSL_ES2_IOS_VER = 64,
		UE_SHADER_GLSL_310_ES_EXT_VER = 64,
		UE_SHADER_GLSL_ES3_1_ANDROID_VER = 64,
	}; 
