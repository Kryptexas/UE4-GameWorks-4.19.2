...
class FShaderFormatGLSL : public IShaderFormat
{
	enum 
	{
		...
		UE_SHADER_GLSL_150_VER = 28,
		UE_SHADER_GLSL_150_MAC_VER = 8,
		UE_SHADER_GLSL_430_VER = 60,
		UE_SHADER_GLSL_ES2_VER = 18,
		UE_SHADER_GLSL_150ES2_VER = 20,
		UE_SHADER_GLSL_150ES2NOUB_VER = 4,
		UE_SHADER_GLSL_150ES3_1_VER = 4,
		UE_SHADER_GLSL_ES2_VER_WEBGL  = 18,
		UE_SHADER_GLSL_ES2_IOS_VER  = 7,
		UE_SHADER_GLSL_310_ES_EXT_VER = 7,
	}; 
