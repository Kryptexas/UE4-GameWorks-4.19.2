...
class FShaderFormatGLSL : public IShaderFormat
{
	enum 
	{
		...
		UE_SHADER_GLSL_150_VER = 25,
		UE_SHADER_GLSL_150_MAC_VER = 5,
		UE_SHADER_GLSL_430_VER = 55,
		UE_SHADER_GLSL_ES2_VER = 13,
		UE_SHADER_GLSL_150ES2_VER = 16,
		UE_SHADER_GLSL_ES2_VER_WEBGL  = 14,
		UE_SHADER_GLSL_ES2_IOS_VER  = 4,
		UE_SHADER_GLSL_310_ES_EXT_VER = 2,
	}; 
