...
public:
	 ...
	 */
	virtual const FString& GetDeviceId( ) = 0;
	...
	/**
	 * Gets the platform of the device (i.e. Windows or Mac).
	 *
...
public:
	 ...
	 * @see OnDeployFailed
	 */
	virtual bool DeployApp( const TMap<FString, FString>& Files, const FGuid& TransactionId ) = 0;
	 ...
	 * @see OnLaunchFailed
	 */
	virtual bool LaunchApp( const FString& AppId, EBuildConfigurations::Type BuildConfiguration, const FString& Params ) = 0;
