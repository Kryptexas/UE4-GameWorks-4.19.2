...
UAISenseImplementation_Prediction::UAISenseImplementation_Prediction(const FObjectInitializer& ObjectInitializer) :
	Super(ObjectInitializer)
{
}

float UAISenseImplementation_Prediction::Update()
{
...
void UAISenseImplementation_Prediction::RegisterEvent(const FAIPredictionEvent& Event)
{
