...
#ifndef VULKAN_USE_PER_LAYOUT_DESCRIPTOR_POOLS
	#define VULKAN_USE_PER_LAYOUT_DESCRIPTOR_POOLS				1
#endif

#if VULKAN_USE_PER_LAYOUT_DESCRIPTOR_POOLS && !VULKAN_USE_PER_PIPELINE_DESCRIPTOR_POOLS
