...
IMPLEMENT_MATERIAL_SHADER_TYPE(, FFlexFluidSurfaceParticleSphereVS, TEXT("/Engine/Private/FlexFluidSurfaceParticleVertexShader.usf"), TEXT("SphereMainVS"), SF_Vertex);
...
IMPLEMENT_MATERIAL_SHADER_TYPE(, FFlexFluidSurfaceParticleEllipsoidVS, TEXT("/Engine/Private/FlexFluidSurfaceParticleVertexShader.usf"), TEXT("EllipsoidMainVS"), SF_Vertex);
...
IMPLEMENT_MATERIAL_SHADER_TYPE(, FFlexFluidSurfaceParticleEllipsoidDepthPS, TEXT("/Engine/Private/FlexFluidSurfaceParticlePixelShader.usf"), TEXT("EllipsoidDepthMainPS"), SF_Pixel);
...
IMPLEMENT_MATERIAL_SHADER_TYPE(, FFlexFluidSurfaceParticleSphereThicknessPS, TEXT("/Engine/Private/FlexFluidSurfaceParticlePixelShader.usf"), TEXT("SphereThicknessMainPS"), SF_Pixel);
...
void DrawParticleMesh(FRHICommandList& RHICmdList, const FViewInfo& View, const FPrimitiveSceneProxy* Proxy, const FMeshBatch& Mesh, const FDrawingPolicyRenderState& DrawRenderState, FMeshMaterialShader* VertexShader, FMeshMaterialShader* PixelShader)
{
	...
	MeshDrawingPolicy.DrawMesh(RHICmdList, Mesh, 0);
}
...
extern ENGINE_API TSet<const FPrimitiveSceneProxy*>& GetFlexFluidSurfaceProxySet();
