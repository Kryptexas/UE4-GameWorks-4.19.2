...
IMPLEMENT_FORWARD_SHADING_BASEPASS_LIGHTMAPPED_SHADER_TYPE(TUniformLightMapPolicy<LMP_FORWARD_DIRECTIONAL_LIGHT_AND_SH_INDIRECT>, FForwardDirectionalLightAndSHIndirectPolicy);
IMPLEMENT_FORWARD_SHADING_BASEPASS_LIGHTMAPPED_SHADER_TYPE(TUniformLightMapPolicy<LMP_FORWARD_DIRECTIONAL_LIGHT_AND_SH_DIRECTIONAL_INDIRECT>, FForwardDirectionalLightAndSHDirectionalIndirectPolicy);
IMPLEMENT_FORWARD_SHADING_BASEPASS_LIGHTMAPPED_SHADER_TYPE(TUniformLightMapPolicy<LMP_FORWARD_DIRECTIONAL_LIGHT_AND_SH_DIRECTIONAL_CSM_INDIRECT>, FForwardDirectionalLightAndSHDirectionalCSMIndirectPolicy);
IMPLEMENT_FORWARD_SHADING_BASEPASS_LIGHTMAPPED_SHADER_TYPE(TUniformLightMapPolicy<LMP_FORWARD_DIRECTIONAL_LIGHT_AND_SH_CSM_INDIRECT>, FForwardDirectionalLightAndSHCSMIndirectPolicy);
...
IMPLEMENT_FORWARD_SHADING_BASEPASS_LIGHTMAPPED_SHADER_TYPE(TUniformLightMapPolicy<LMP_MOVABLE_DIRECTIONAL_LIGHT_CSM_WITH_LIGHTMAP>, FMovableDirectionalLightCSMWithLightmapLightingPolicy);


template<typename PixelParametersType, int32 NumDynamicPointLights>
bool TBasePassForForwardShadingPSPolicyParamType<PixelParametersType, NumDynamicPointLights>::ModifyCompilationEnvironmentForQualityLevel(EShaderPlatform Platform, EMaterialQualityLevel::Type QualityLevel, FShaderCompilerEnvironment& OutEnvironment)
{
