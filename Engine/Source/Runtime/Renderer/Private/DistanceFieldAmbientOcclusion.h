...
{
	return Platform == SP_PCD3D_SM5 || Platform == SP_PS4 || Platform == SP_XBOXONE_D3D12 || Platform == SP_XBOXONE_D3D11 || (Platform == SP_METAL_SM5 && RHIGetShaderLanguageVersion(Platform) >= 2);
}
