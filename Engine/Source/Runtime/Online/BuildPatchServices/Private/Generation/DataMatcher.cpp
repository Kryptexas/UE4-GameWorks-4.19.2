...
namespace FBuildPatchServices
{
	...
	public:
		...
		virtual bool CompareData(const FGuid& DataGuid, uint64 Hash, const TArray<uint8>& NewData) const override;
	...
	bool FDataMatcherImpl::CompareData(const FGuid& DataGuid, uint64 Hash, const TArray<uint8>& NewData) const
	{
