...
public:
	 ...
	 */
	static bool CompactifyCloudDirectory(const bool bPreview);
	 ...
	 * @return              true if no file errors occurred
	 */
	static bool CompactifyCloudDirectory(const FString& CloudDir, const bool bPreview);

private:
	FString CloudDir;

	// Hide the default constructor
	FBuildDataCompactifier();

	/**
	 * Constructor.
	 * @param CloudDir      The directory that this compactifier should operate on.
	 */
	FBuildDataCompactifier(const FString& CloudDir);
	 ...
	 * @return              true if no file errors occurred
	 */
	bool Compactify(const bool bPreview) const;

	/**
	 * Deletes the specified file, and logs the deletion
	 * @param FilePath     The path to the file to delete
	 * @param bPreview     If true, then the file is not actually deleted.
	 */
	void DeleteFile(const FString& FilePath, const bool bPreview) const;
