...
public:
	...
	const WidgetStyleType& GetWidgetStyle( FName PropertyName, const ANSICHAR* Specifier = NULL ) const 
	{
	...
	template< typename WidgetStyleType >            
	bool HasWidgetStyle( FName PropertyName, const ANSICHAR* Specifier = NULL ) const
	{
		return GetWidgetStyleInternal( WidgetStyleType::TypeName, Join( PropertyName, Specifier ) ) != NULL;
	}
	 ...
	 */
	virtual float GetFloat( const FName PropertyName, const ANSICHAR* Specifier = NULL ) const = 0;
	 ...
	 */
	virtual FVector2D GetVector( const FName PropertyName, const ANSICHAR* Specifier = NULL ) const = 0;
	 ...
	 */
	virtual const FLinearColor& GetColor( const FName PropertyName, const ANSICHAR* Specifier = NULL ) const = 0;
	 ...
	 * @return a FLinearColor property.
	 */
	virtual const FSlateColor GetSlateColor( const FName PropertyName, const ANSICHAR* Specifier = NULL ) const = 0;
	 ...
	 */
	virtual const FMargin& GetMargin( const FName PropertyName, const ANSICHAR* Specifier = NULL ) const = 0;
	 ...
	 */		
	virtual FSlateFontInfo GetFontStyle( const FName PropertyName, const ANSICHAR* Specifier = NULL ) const = 0;
