...
TSharedPtr< ISlateStyle > FCoreStyle::Instance = NULL;

class FSlateCoreStyle : public FSlateStyleSet
{
public:
...
TSharedRef< ISlateStyle > FCoreStyle::Create( const FName& InStyleSetName )
{
	...
	// Error Reporting
	{
		...
		Style->Set( "ErrorReporting.BackgroundColor", FLinearColor(0.35f,0,0) );
	...
	// SWindow defaults...
	{
		...
		const FButtonStyle MinimizeButtonStyle = FButtonStyle(Button)
			.SetNormal ( IMAGE_BRUSH( "Common/Window/WindowButton_Mac_Minimize_Normal", FVector2D(20, 20) ) )
			.SetHovered( IMAGE_BRUSH( "Common/Window/WindowButton_Mac_Minimize_Hovered", FVector2D(20, 20) ) )
			.SetPressed( IMAGE_BRUSH( "Common/Window/WindowButton_Mac_Minimize_Pressed", FVector2D(20, 20) ) )
			.SetDisabled( IMAGE_BRUSH( "Common/Window/WindowButton_Mac_Disabled", FVector2D(20, 20) ) );

		const FButtonStyle MaximizeButtonStyle = FButtonStyle(Button)
			.SetNormal ( IMAGE_BRUSH( "Common/Window/WindowButton_Mac_Maximize_Normal", FVector2D(20, 20) ) )
			.SetHovered( IMAGE_BRUSH( "Common/Window/WindowButton_Mac_Maximize_Hovered", FVector2D(20, 20) ) )
			.SetPressed( IMAGE_BRUSH( "Common/Window/WindowButton_Mac_Maximize_Pressed", FVector2D(20, 20) ) )
			.SetDisabled( IMAGE_BRUSH( "Common/Window/WindowButton_Mac_Disabled", FVector2D(20, 20) ) );
		...
		const FButtonStyle CloseButtonStyle = FButtonStyle(Button)
			.SetNormal ( IMAGE_BRUSH( "Common/Window/WindowButton_Mac_Close_Normal", FVector2D(20, 20) ) )
			.SetHovered( IMAGE_BRUSH( "Common/Window/WindowButton_Mac_Close_Hovered", FVector2D(20, 20) ) )
			.SetPressed( IMAGE_BRUSH( "Common/Window/WindowButton_Mac_Close_Pressed", FVector2D(20, 20) ) )
			.SetDisabled( IMAGE_BRUSH( "Common/Window/WindowButton_Mac_Disabled", FVector2D(20, 20) ) );
#else
		const FButtonStyle MinimizeButtonStyle = FButtonStyle(Button)
			.SetNormal ( IMAGE_BRUSH( "Common/Window/WindowButton_Minimize_Normal", FVector2D(27, 18) ) )
			.SetHovered( IMAGE_BRUSH( "Common/Window/WindowButton_Minimize_Hovered", FVector2D(27, 18) ) )
			.SetPressed( IMAGE_BRUSH( "Common/Window/WindowButton_Minimize_Pressed", FVector2D(27, 18) ) )
			.SetDisabled( IMAGE_BRUSH( "Common/Window/WindowButton_Minimize_Disabled", FVector2D(27, 18) ) );

		const FButtonStyle MaximizeButtonStyle = FButtonStyle(Button)
			.SetNormal ( IMAGE_BRUSH( "Common/Window/WindowButton_Maximize_Normal", FVector2D(23, 18) ) )
			.SetHovered( IMAGE_BRUSH( "Common/Window/WindowButton_Maximize_Hovered", FVector2D(23, 18) ) )
			.SetPressed( IMAGE_BRUSH( "Common/Window/WindowButton_Maximize_Pressed", FVector2D(23, 18) ) )
			.SetDisabled( IMAGE_BRUSH( "Common/Window/WindowButton_Maximize_Disabled", FVector2D(23, 18) ) );

		const FButtonStyle RestoreButtonStyle = FButtonStyle(Button)
			.SetNormal ( IMAGE_BRUSH( "Common/Window/WindowButton_Restore_Normal", FVector2D(23, 18) ) )
			.SetHovered( IMAGE_BRUSH( "Common/Window/WindowButton_Restore_Hovered", FVector2D(23, 18) ) )
			.SetPressed( IMAGE_BRUSH( "Common/Window/WindowButton_Restore_Pressed", FVector2D(23, 18) ) );

		const FButtonStyle CloseButtonStyle = FButtonStyle(Button)
			.SetNormal ( IMAGE_BRUSH( "Common/Window/WindowButton_Close_Normal", FVector2D(44, 18) ) )
			.SetHovered( IMAGE_BRUSH( "Common/Window/WindowButton_Close_Hovered", FVector2D(44, 18) ) )
			.SetPressed( IMAGE_BRUSH( "Common/Window/WindowButton_Close_Pressed", FVector2D(44, 18) ) );
#endif
	...
	// Slate RHI Renderer - Crash Tracker
	{
		...
		Style->Set( "CrashTracker.Cursor", new IMAGE_BRUSH( "CrashTracker/MouseCursor", Icon32x32, FLinearColor(1,1,1,1), ESlateBrushTileType::Both ) );
