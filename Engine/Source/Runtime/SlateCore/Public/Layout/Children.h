...
class SLATECORE_API FSimpleSlot : public TSupportsOneChildMixin<SWidget, FSimpleSlot>, public TSupportsContentAlignmentMixin<FSimpleSlot>, public TSupportsContentPaddingMixin<FSimpleSlot>
{
public:
	FSimpleSlot()
