...
ENGINE_API TSet<const FPrimitiveSceneProxy*>& GetFlexFluidSurfaceProxySet()
{
...
class ENGINE_API FFlexFluidSurfaceParticleVertexFactory : public FVertexFactory
{
...
bool FFlexFluidSurfaceParticleVertexFactory::ShouldCache(EShaderPlatform Platform, const class FMaterial* Material, const class FShaderType* ShaderType)
{
...
IMPLEMENT_VERTEX_FACTORY_TYPE(FFlexFluidSurfaceParticleVertexFactory, "/Engine/Private/FlexFluidSurfaceParticleVertexFactory.ush", true, false, true, false, false);
...
public:
	...
	FFlexFluidSurfaceVertexFactory(FFlexFluidSurfaceTextures* InTextures) : FVertexFactory(), Textures(InTextures) {}
