...
bool FIntSerializationTest::RunTest (const FString& Parameters)
{
	...
	//SerializableObject->
	UIntSerialization* SerializableObject = new UIntSerialization(FPostConstructInitializeProperties());
	...
	UIntSerialization* DeSerializableObject = new UIntSerialization(FPostConstructInitializeProperties());
