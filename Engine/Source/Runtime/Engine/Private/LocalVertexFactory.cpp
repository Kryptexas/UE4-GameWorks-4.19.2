...
void FLocalVertexFactory::AddVertexPositionElements(DataType& InData, FVertexDeclarationElementList& Elements)
{
	Elements.Add(AccessPositionStreamComponent(InData.PositionComponent,0));
}

void FLocalVertexFactory::AddVertexElements(DataType& InData, FVertexDeclarationElementList& Elements)
{
