...
class UExporter : public UObject
{
	 ...
	 */
	ENGINE_API void ExportObjectInner(const class FExportObjectInnerContext* Context, UObject* Object, FOutputDevice& Ar, uint32 PortFlags, bool bSkipComponents=false);
...
protected:
	 ...
	 *
	 * @param	Components		the components to export.  This map is typically generated by calling CollectDefaultSubobjects on the object being exported
	 ...
	 */
	void ExportComponentDefinitions(const FExportObjectInnerContext* Context, const TArray<UObject*>& Components, FOutputDevice& Ar, uint32 PortFlags);
	 ...
	 * @param	PortFlags		the flags that were passed into the call to ExportText
	 */
	virtual void ExportComponentExtra( const FExportObjectInnerContext* Context, const TArray<UObject*>& Components, FOutputDevice& Ar, uint32 PortFlags) {}
