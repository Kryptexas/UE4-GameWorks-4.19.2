...
BEGIN_UNIFORM_BUFFER_STRUCT_WITH_CONSTRUCTOR(FViewUniformShaderParameters,ENGINE_API)
	...
	DECLARE_UNIFORM_BUFFER_STRUCT_MEMBER(FVector,CameraWorldOrigin)
	DECLARE_UNIFORM_BUFFER_STRUCT_MEMBER(FVector,CameraTranslatedWorldOrigin)
	DECLARE_UNIFORM_BUFFER_STRUCT_MEMBER(FVector,ViewWorldOrigin)
	...
	DECLARE_UNIFORM_BUFFER_STRUCT_MEMBER(FVector,CameraWorldOriginDelta)
	...
	DECLARE_UNIFORM_BUFFER_STRUCT_MEMBER(FVector,PrevCameraWorldOrigin)
	DECLARE_UNIFORM_BUFFER_STRUCT_MEMBER(FVector,PrevViewWorldOrigin)
