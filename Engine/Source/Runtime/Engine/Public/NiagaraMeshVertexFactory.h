...
*/
BEGIN_UNIFORM_BUFFER_STRUCT(FNiagaraMeshUniformParameters, ENGINE_API)
...
*/
class ENGINE_API FNiagaraMeshVertexFactory : public FNiagaraVertexFactoryBase
{
...
class ENGINE_API FNiagaraMeshVertexFactoryEmulatedInstancing : public FNiagaraMeshVertexFactory
{
