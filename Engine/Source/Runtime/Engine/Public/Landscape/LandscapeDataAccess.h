...
struct FLandscapeComponentDataInterface
{
	...
	// tors
	ENGINE_API FLandscapeComponentDataInterface(ULandscapeComponent* InComponent, int32 InMipLevel = 0);
	ENGINE_API ~FLandscapeComponentDataInterface();
...
//#endif
	...
	ENGINE_API FVector GetLocalVertex(int32 LocalX, int32 LocalY) const;
	...
	ENGINE_API FVector GetWorldVertex(int32 LocalX, int32 LocalY) const;

	ENGINE_API void GetWorldTangentVectors(int32 LocalX, int32 LocalY, FVector& WorldTangentX, FVector& WorldTangentY, FVector& WorldTangentZ) const;

	ENGINE_API void GetWorldPositionTangents(int32 LocalX, int32 LocalY, FVector& WorldPos, FVector& WorldTangentX, FVector& WorldTangentY, FVector& WorldTangentZ) const;
