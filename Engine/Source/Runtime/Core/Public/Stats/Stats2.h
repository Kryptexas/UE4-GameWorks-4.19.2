...
DECLARE_STATS_GROUP(TEXT("CollisionVerbose"),STATGROUP_CollisionVerbose, STATCAT_Advanced);
...
DECLARE_STATS_GROUP(TEXT("MathVerbose"), STATGROUP_MathVerbose, STATCAT_Advanced);
