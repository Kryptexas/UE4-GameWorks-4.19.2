...
class CORE_API FLineBreakIterator
{
public:
	FLineBreakIterator(const FText& Text);
	FLineBreakIterator(const FString& String);
	FLineBreakIterator(const TCHAR* const String, const int32 StringLength);
