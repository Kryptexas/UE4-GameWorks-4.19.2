...
class CORE_API FWordBreakIterator
{
public:
	FWordBreakIterator(const FText& Text);
	FWordBreakIterator(const FString& String);
	FWordBreakIterator(const TCHAR* const String, const int32 StringLength);
