...
public:
	 ...
	 * @param StartIndex Index of element from which to start searching. Defaults to index of last element in array.
	 *
	 * @returns Index of the found element. INDEX_NONE otherwise.
	 */
	template <typename Predicate>
	int32 FindLastByPredicate(Predicate Pred, int32 StartIndex = ArrayNum) const
	{
