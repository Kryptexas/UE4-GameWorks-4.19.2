...
DECLARE_DYNAMIC_MULTICAST_DELEGATE(FApplyRootMotionMoveToActorForceDelegate);
...
class UAbilityTask_ApplyRootMotionMoveToActorForce : public UAbilityTask
{
	...
	FApplyRootMotionMoveToActorForceDelegate OnTimedOut;

	UPROPERTY(BlueprintAssignable)
	FApplyRootMotionMoveToActorForceDelegate OnTimedOutAndDestinationReached;
