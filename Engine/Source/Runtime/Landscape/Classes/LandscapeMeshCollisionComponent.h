...
class ULandscapeMeshCollisionComponent : public ULandscapeHeightfieldCollisionComponent
{
	...
	virtual bool CookCollsionData(const FName& Format, bool bUseOnlyDefMaterial, TArray<uint8>& OutCookedData, TArray<UPhysicalMaterial*>& OutMaterials) const override;
#endif
