...
public:
	...
	virtual bool UpdateTexture3D_ComputeShader(FD3D12Texture3D* Texture, uint32 MipIndex, const FUpdateTextureRegion3D& UpdateRegion, uint32 SourceRowPitch, uint32 SourceDepthPitch, const uint8* SourceData)
	{
		// Not supported on PC
		return false;
	}
