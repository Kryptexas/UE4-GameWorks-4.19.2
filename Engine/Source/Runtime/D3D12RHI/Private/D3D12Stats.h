...
DECLARE_DWORD_COUNTER_STAT_EXTERN(TEXT("Lock Buffer calls"), STAT_D3D12LockBufferCalls, STATGROUP_D3D12RHI, );
DECLARE_CYCLE_STAT_EXTERN(TEXT("Lock Buffer time"), STAT_D3D12LockBufferTime, STATGROUP_D3D12RHI, );
