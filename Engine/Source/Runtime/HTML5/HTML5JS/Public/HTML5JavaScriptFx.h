...
#pragma  once 
	...
	extern "C" { 
		 ...
		 void UE_MakeHTTPDataRequest(void *ctx, const char* url, const char* verb, const char* payload, int freeBuffer, void(*onload)(void*, void*, unsigned), void(*onerror)(void*, int, const char*), void(*onprogress)(void*, int, int));
	}
