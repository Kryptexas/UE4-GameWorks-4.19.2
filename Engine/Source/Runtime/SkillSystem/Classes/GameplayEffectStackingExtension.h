...
{
	FGameplayEffectStackingCallbackData(const FGameplayEffectSpec & InEffectSpec, const FModifierSpec & InModifierSpec, FGameplayModifierEvaluatedData & InEvaluatedData, UAttributeComponent & InTarget)
...
class SKILLSYSTEM_API UGameplayEffectStackingExtension: public UObject
{
