...
namespace UnrealBuildTool
{
	...
	class XcodeProjectFile : ProjectFile
	{
		...
		private void WriteSchemeFile(string TargetName, string TargetGuid, string BuildTargetGuid, string IndexTargetGuid, bool bHasEditorConfiguration, string GameProjectPath)
		{
			...
			Content.Append("      <PostActions>" + ProjectFileGenerator.NewLine);
			Content.Append("         <ExecutionAction" + ProjectFileGenerator.NewLine);
			Content.Append("            ActionType = \"Xcode.IDEStandardExecutionActionsCore.ExecutionActionType.ShellScriptAction\">" + ProjectFileGenerator.NewLine);
			Content.Append("            <ActionContent" + ProjectFileGenerator.NewLine);
			Content.Append("               title = \"Run Script\"" + ProjectFileGenerator.NewLine);
			Content.Append("               scriptText = \"if [ $PLATFORM_NAME == &quot;iphoneos&quot; ] || [ $PLATFORM_NAME == &quot;appletvos&quot; ]; then&#10;if [ ! $CONFIGURATION == &quot;Development&quot; ]; then&#10;rm -rf &quot;$TARGET_BUILD_DIR/$EXECUTABLE_NAME-Mac-$CONFIGURATION.app&quot;&#10;$CP -R &quot;$TARGET_BUILD_DIR/$EXECUTABLE_NAME.app&quot; &quot;$TARGET_BUILD_DIR/$EXECUTABLE_NAME-Mac-$CONFIGURATION.app&quot;&#10;fi&#10;fi\">" + ProjectFileGenerator.NewLine);
			Content.Append("               <EnvironmentBuildable>" + ProjectFileGenerator.NewLine);
