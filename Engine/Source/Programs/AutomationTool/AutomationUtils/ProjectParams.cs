...
namespace AutomationTool
{
	...
	public class ProjectParams
	{
		...
		public ProjectParams(			
			...
			string Certificate = null,
			ParamList<string> InMapsToRebuildLightMaps = null,
			string CreateReleaseVersionBasePath = null, //unused
			string BasedOnReleaseVersionBasePath = null, //unused
			bool StageNonMonolithic = false //unused
			)
			: this(
				new FileReference(RawProjectPath),

				Command: Command,
				Device: Device,			
				MapToRun: MapToRun,	
				AdditionalServerMapParams: AdditionalServerMapParams,
				Port: Port,
				RunCommandline: RunCommandline,						
				StageCommandline: StageCommandline,
				BundleName: BundleName,
				StageDirectoryParam: StageDirectoryParam,
				UE4Exe: UE4Exe,
				SignPak: SignPak,
				ClientConfigsToBuild: ClientConfigsToBuild,
				ServerConfigsToBuild: ServerConfigsToBuild,
				MapsToCook: MapsToCook,
				DirectoriesToCook: DirectoriesToCook,
				InternationalizationPreset: InternationalizationPreset,
				CulturesToCook: CulturesToCook,
				ClientCookedTargets: ClientCookedTargets,
				EditorTargets: EditorTargets,
				ServerCookedTargets: ServerCookedTargets,
				ClientTargetPlatforms: ClientTargetPlatforms,
				ClientDependentPlatformMap: ClientDependentPlatformMap,
				ServerTargetPlatforms: ServerTargetPlatforms,
				ServerDependentPlatformMap: ServerDependentPlatformMap,
				Build: Build,
				Cook: Cook,
				...
				UseDebugParamForEditorExe: UseDebugParamForEditorExe,
				IterativeCooking: IterativeCooking,
				CookAll: CookAll,
				CookMapsOnly: CookMapsOnly,
				CookOnTheFly: CookOnTheFly,
				CookOnTheFlyStreaming: CookOnTheFlyStreaming,
				UnversionedCookedContent: UnversionedCookedContent,
				SkipCookingEditorContent: SkipCookingEditorContent,
				NumCookersToSpawn: NumCookersToSpawn,
				...
				DLCName: DLCName,
				DiffCookedContentPath: DiffCookedContentPath,
				DLCIncludeEngineContent: DLCIncludeEngineContent,
				NewCook: NewCook,
				OldCook: OldCook,
				...
				Pak: Pak,
				Prereqs: Prereqs,
				NoBootstrapExe: NoBootstrapExe,
				SignedPak: SignedPak,
				NullRHI: NullRHI,
				FakeClient: FakeClient,
				EditorTest: EditorTest,
				RunAutomationTests: RunAutomationTests,
				RunAutomationTest: RunAutomationTest,
				CrashIndex: CrashIndex,
				Rocket: Rocket,
				SkipCook: SkipCook,
				SkipCookOnTheFly: SkipCookOnTheFly,
				SkipPak: SkipPak,
				SkipStage: SkipStage,
				Stage: Stage,
				Manifests: Manifests,
				CreateChunkInstall: CreateChunkInstall,
				Unattended: Unattended,
				NumClients: NumClients,
				Archive: Archive,
				ArchiveDirectoryParam: ArchiveDirectoryParam,
				ArchiveMetaData: ArchiveMetaData,
				CreateAppBundle: CreateAppBundle,
				ProgramTargets: ProgramTargets,
				Distribution: Distribution,
				Prebuilt: Prebuilt,
				RunTimeoutSeconds: RunTimeoutSeconds,
				SpecifiedArchitecture: SpecifiedArchitecture,
				IterativeDeploy: IterativeDeploy,
				FastCook: FastCook,
				IgnoreCookErrors: IgnoreCookErrors,
				CodeSign: CodeSign,
				UploadSymbols: UploadSymbols,
				Provision: Provision,
				Certificate: Certificate,
				InMapsToRebuildLightMaps: InMapsToRebuildLightMaps
			)
		{
		}
