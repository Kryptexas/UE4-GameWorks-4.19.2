...
namespace Tools.CrashReporter.CrashReportWebSite.Models
{
    ...
    partial void InsertPIIMapping(PIIMapping instance);
    partial void UpdatePIIMapping(PIIMapping instance);
    partial void DeletePIIMapping(PIIMapping instance);
    #endregion
		...
		public System.Data.Linq.Table<PIIMapping> PIIMappings
		{
			get
			{
				return this.GetTable<PIIMapping>();
			}
		}
	}
	...
	public partial class User : INotifyPropertyChanging, INotifyPropertyChanged
	{
		...
		private EntitySet<PIIMapping> _PIIMappings;
    ...
    partial void OnUserGroupIdChanged();
		...
		public User()
		{
			...
			this._PIIMappings = new EntitySet<PIIMapping>(new Action<PIIMapping>(this.attach_PIIMappings), new Action<PIIMapping>(this.detach_PIIMappings));
		...
		[global::System.Data.Linq.Mapping.AssociationAttribute(Name="User_PIIMapping", Storage="_PIIMappings", ThisKey="Id", OtherKey="UserNameId")]
		public EntitySet<PIIMapping> PIIMappings
		{
			get
			{
				return this._PIIMappings;
			}
			set
			{
				this._PIIMappings.Assign(value);
			}
		}
		...
		private void attach_PIIMappings(PIIMapping entity)
		{
			this.SendPropertyChanging();
			entity.User = this;
		}
		
		private void detach_PIIMappings(PIIMapping entity)
		{
			this.SendPropertyChanging();
			entity.User = null;
		}
	...
	[global::System.Data.Linq.Mapping.TableAttribute(Name="dbo.PIIMapping")]
	public partial class PIIMapping : INotifyPropertyChanging, INotifyPropertyChanged
	{
    ...
    partial void OnIDChanging(int value);
    partial void OnIDChanged();
    partial void OnUserNameIdChanging(int value);
    partial void OnUserNameIdChanged();
    ...
    partial void OnMachineNameChanged();
		...
		[global::System.Data.Linq.Mapping.ColumnAttribute(Storage="_UserNameId", DbType="Int NOT NULL")]
		...
		[global::System.Data.Linq.Mapping.ColumnAttribute(Storage="_MachineGUID", DbType="VarChar(64) NOT NULL", CanBeNull=false)]
		...
		[global::System.Data.Linq.Mapping.ColumnAttribute(Storage="_MachineName", DbType="VarChar(64) NOT NULL", CanBeNull=false)]
		...
		[global::System.Data.Linq.Mapping.AssociationAttribute(Name="User_PIIMapping", Storage="_User", ThisKey="UserNameId", OtherKey="Id", IsForeignKey=true)]
		public User User
		{
			get
			{
			...
			set
			{
							...
							|| (this._User.HasLoadedOrAssignedValue == false)))
				{
					...
					{
						this._User.Entity = null;
						previousValue.PIIMappings.Remove(this);
					}
					this._User.Entity = value;
					if ((value != null))
					{
						value.PIIMappings.Add(this);
						this._UserNameId = value.Id;
					}
					else
					{
						this._UserNameId = default(int);
					}
					this.SendPropertyChanged("User");
				}
			}
