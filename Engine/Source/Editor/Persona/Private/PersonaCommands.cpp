...
void FPersonaCommands::RegisterCommands()
{
	...
	UI_COMMAND( RetargetSourceMgr, "Retarget Source Manager", "Create, delete, or edit retarget sources for this skeleton. ", EUserInterfaceActionType::Button, FInputGesture() );
