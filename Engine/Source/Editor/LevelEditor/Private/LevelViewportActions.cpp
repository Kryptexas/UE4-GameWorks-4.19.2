...
void FLevelViewportCommands::RegisterCommands()
{
	...
	UI_COMMAND( ToggleCinematicPreview, "Toggles Cinemaic Preview", "If enabled, allows Matinee or Sequencer previews to play in this viewport", EUserInterfaceActionType::ToggleButton, FInputChord() );
