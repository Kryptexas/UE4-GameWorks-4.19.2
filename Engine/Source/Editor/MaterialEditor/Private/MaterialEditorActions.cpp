...
void FMaterialEditorCommands::RegisterCommands()
{
	...
	UI_COMMAND( ToggleStats, "Stats", "Toggles displaying of the material's stats.", EUserInterfaceActionType::ToggleButton, FInputGesture() );
	...
	UI_COMMAND( PasteHere, "Paste Here", "Pastes copied items at this location.", EUserInterfaceActionType::Button, FInputGesture() );
