...
void FSlateEditorStyle::FStyle::SetupLevelEditorStyle()
...
#if WITH_EDITOR
	{
		...
		Set( "EditorViewport.WantedMipsAccuracyMode", new IMAGE_BRUSH( "Icons/icon_ViewMode_WantedMipsAccuracy_16px", Icon16x16 ) );
		Set( "EditorViewport.TexelFactorAccuracyMode", new IMAGE_BRUSH( "Icons/icon_ViewMode_TexelFactorAccuracy_16px", Icon16x16 ) );
