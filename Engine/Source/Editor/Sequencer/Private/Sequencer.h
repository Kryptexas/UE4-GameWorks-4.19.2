...
public:
	...
	virtual TSharedPtr<FUICommandList> GetCommandBindings() const override { return SequencerCommandBindings; }
...
public:
	...
	virtual TSharedRef<SWidget> MakeTransportControls() override;
