...
namespace CodeView
{
	...
	private:
		...
		FString GetSelectedModeText() const;
	private:

		/** True if we're ready to be populated */
		UNREALED_API static bool bReadyToPopulate;
