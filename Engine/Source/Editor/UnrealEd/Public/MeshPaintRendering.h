...
namespace MeshPaintRendering
{
	...
	void UNREALED_API SetMeshPaintShaders_RenderThread( const FMatrix& InTransform,
										   const float InGamma,
	...
	void UNREALED_API SetMeshPaintDilateShaders_RenderThread( const FMatrix& InTransform,
												const float InGamma,
