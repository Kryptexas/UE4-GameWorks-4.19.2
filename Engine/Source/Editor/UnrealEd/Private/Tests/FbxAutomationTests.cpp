...
*/
IMPLEMENT_COMPLEX_AUTOMATION_TEST(FFbxImportAssetsAutomationTest, "System.Editor.Import.Fbx", (EAutomationTestFlags::EditorContext | EAutomationTestFlags::NonNullRHI | EAutomationTestFlags::EngineFilter))
					...
					if (Object->IsA(UStaticMesh::StaticClass()))
					{
						...
						else
						{
							...
							else
							{
								...
								{
									MaterialName = Mesh->Materials[MaterialIndex]->GetName();
								}
							}
						}
					}
