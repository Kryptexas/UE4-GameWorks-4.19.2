...
*/
IMPLEMENT_COMPLEX_AUTOMATION_TEST( FViewportShowflagsToggleOnTest, "Editor.Viewport.Showflags.Toggle On", EAutomationTestFlags::ATF_Editor );
...
*/
IMPLEMENT_COMPLEX_AUTOMATION_TEST(FViewportShowflagsToggleOffTest, "Editor.Viewport.Showflags.Toggle Off", EAutomationTestFlags::ATF_Editor);
