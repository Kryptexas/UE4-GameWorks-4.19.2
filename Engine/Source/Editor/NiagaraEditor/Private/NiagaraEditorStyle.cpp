...
TSharedRef< FSlateStyleSet > FNiagaraEditorStyle::Create()
{
	...
	const FEditableTextBoxStyle NormalEditableTextBox = FEditorStyle::GetWidgetStyle<FEditableTextBoxStyle>("NormalEditableTextBox");
	...
	Style->Set("NiagaraEditor.MaterialWarningBorder", new BOX_BRUSH("Common/GroupBorderLight", FMargin(4.0f / 16.0f)));
