...
# Don't forget to add -m32 for 32-bit builds
./Configure shared threads no-ssl2 no-zlib $OPENSSL_ARCH --prefix=$OPENSSL_INSTALL_DIR > $DEST_DIR/openssl-configure.log
