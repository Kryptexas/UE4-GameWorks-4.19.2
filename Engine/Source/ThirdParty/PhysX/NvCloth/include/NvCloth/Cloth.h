...
class Cloth : public UserAllocated
{
  ...
  public:
	...
	/** \brief Set the translation of the local space simulation after next call to simulate(). 
		...
		This doesn’t move the particles as they are in local space.
	...
	*/
	...
	/** \brief Enables planes for collision.
	...
	virtual void setTriangles(Range<const physx::PxVec3>, uint32_t first, uint32_t last) = 0;
	virtual void setTriangles(Range<const physx::PxVec3>, Range<const physx::PxVec3>, uint32_t first) = 0;
