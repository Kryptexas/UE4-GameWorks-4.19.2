...
using namespace EmitterGeomSphereShellParamsNS;

const char* const EmitterGeomSphereShellParamsFactory::vptr =
    NxParameterized::getVptr<EmitterGeomSphereShellParams, EmitterGeomSphereShellParams::ClassAlignment>();
...
bool EmitterGeomSphereShellParams::mBuiltFlag = false;
NxParameterized::MutexType EmitterGeomSphereShellParams::mBuiltFlagMutex;

EmitterGeomSphereShellParams::EmitterGeomSphereShellParams(NxParameterized::Traits* traits, void* buf, PxI32* refCount) :
	NxParameters(traits, buf, refCount)
{
	//mParameterizedTraits->registerFactory(className(), &EmitterGeomSphereShellParamsFactoryInst);
...
EmitterGeomSphereShellParams::~EmitterGeomSphereShellParams()
{
	freeStrings();
	freeReferences();
	freeDynamicArrays();
...
void EmitterGeomSphereShellParams::destroy()
{
	...
	this->~EmitterGeomSphereShellParams();

	NxParameters::destroy(this, traits, doDeallocateSelf, refCount, buf);
}

const NxParameterized::DefinitionImpl* EmitterGeomSphereShellParams::getParameterDefinitionTree(void)
{
...
const NxParameterized::DefinitionImpl* EmitterGeomSphereShellParams::getParameterDefinitionTree(void) const
{
	EmitterGeomSphereShellParams* tmpParam = const_cast<EmitterGeomSphereShellParams*>(this);
...
NxParameterized::ErrorType EmitterGeomSphereShellParams::getParameterHandle(const char* long_name, Handle& handle) const
{
...
NxParameterized::ErrorType EmitterGeomSphereShellParams::getParameterHandle(const char* long_name, Handle& handle)
{
	ErrorType Ret = NxParameters::getParameterHandle(long_name, handle);
	if (Ret != ERROR_NONE)
	{
...
void EmitterGeomSphereShellParams::getVarPtr(const Handle& handle, void*& ptr, size_t& offset) const
{
	ptr = getVarPtrHelper(&ParamLookupTable[0], const_cast<EmitterGeomSphereShellParams::ParametersStruct*>(&parameters()), handle, offset);
}


/* Dynamic Handle Indices */

void EmitterGeomSphereShellParams::freeParameterDefinitionTable(NxParameterized::Traits* traits)
{
	if (!traits)
	{
		return;
...
void EmitterGeomSphereShellParams::buildTree(void)
{
...
void EmitterGeomSphereShellParams::initStrings(void)
{
}

void EmitterGeomSphereShellParams::initDynamicArrays(void)
{
}

void EmitterGeomSphereShellParams::initDefaults(void)
{
...
void EmitterGeomSphereShellParams::initReferences(void)
{
}

void EmitterGeomSphereShellParams::freeDynamicArrays(void)
{
}

void EmitterGeomSphereShellParams::freeStrings(void)
{
}

void EmitterGeomSphereShellParams::freeReferences(void)
{
}
