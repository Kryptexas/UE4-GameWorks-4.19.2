...
set CXXFLAGS= -g -O3 -ffunction-sections -funwind-tables -fstack-protector -fno-strict-aliasing -fno-exceptions -fno-rtti -fno-short-enums -fPIC -m64  -x c

rem neeeds to be absolute
rem set M4=%LINUX_ROOT%/bin/m4.exe
set CC=%LINUX_ROOT%/bin/clang.exe
set AR_RC=%LINUX_ROOT%/bin/x86_64-unknown-linux-gnu-ar.exe rc
set RANLIB=%LINUX_ROOT%/bin/x86_64-unknown-linux-gnu-ranlib.exe
...
%CC% %CXXFLAGS% %INCLUDE% -c -target x86_64-unknown-linux-gnu --sysroot=%LINUX_ROOT% %SRCS%

%AR_RC% %OUTPUT_LIB% %OBJ%
%RANLIB% %OUTPUT_LIB%

echo Now replace libelf.a in lib/Linux/ with file from this directory
p4 open ../../../lib/Linux/libelf.a
move libelf.a ../../../lib/Linux/
