...
// Updates the predicted head's pose in Start Space at given time of the
// Clock. This updates the internal state. This function offers smoother
// prediction without adding latency.
//
// Usage
//   - Use update_head_pose_in_start_space() rather than
//     get_head_pose_in_start_space() if you don't use EDS and currently call
//     get_head_pose_in_start_space() once per frame.
//   - If you are implementing EDS on your own, use
//     get_head_pose_in_start_space() at the begining of your render loop and
//     update_head_pose_in_start_space() during the EDS path to get the latest
//     gyroscope data.
//
// @param gvr Pointer to the gvr instance for which the canonical pose will be
//     updated and returned.
// @param time The time of the Clock at which to get the head pose. The time
//     should be in the future.
// @return Head pose in Start Space.
gvr_head_pose gvr_update_head_pose_in_start_space(gvr_context* gvr,
                                                  gvr_clock_time_point time);
...
class GvrApi {
 public:
  ...
  // For more information, see gvr_update_head_pose_in_start_space().
  HeadPose UpdateHeadPoseInStartSpace(ClockTimePoint time) {
    return gvr_update_head_pose_in_start_space(context_, time);
  }
