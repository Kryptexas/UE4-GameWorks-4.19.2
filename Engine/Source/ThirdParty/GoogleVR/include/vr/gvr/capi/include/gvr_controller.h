...
// Represents a GVR controller API object, used to invoke the
// Google VR controller API.
...
// to invoke the Google VR controller API functions. Important: after creation
