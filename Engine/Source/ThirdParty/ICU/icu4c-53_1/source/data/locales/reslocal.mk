...
GENRB_SYNTHETIC_ALIAS = en_NH.txt en_RH.txt\
...
# Ordinary resources
GENRB_SOURCE = de.txt de_AT.txt\
 de_BE.txt de_CH.txt de_DE.txt de_LI.txt de_LU.txt\
 en.txt en_001.txt en_150.txt en_AG.txt\
 ...
 es.txt es_419.txt es_AR.txt es_BO.txt\
