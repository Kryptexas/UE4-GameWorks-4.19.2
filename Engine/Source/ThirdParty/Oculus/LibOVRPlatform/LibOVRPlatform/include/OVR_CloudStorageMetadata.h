...
OVRP_PUBLIC_FUNCTION(ovrCloudStorageSaveHandle) ovr_CloudStorageMetadata_GetHandle(const ovrCloudStorageMetadataHandle obj);
...
OVRP_PUBLIC_FUNCTION(unsigned long long)        ovr_CloudStorageMetadata_GetUTCSaveTime(const ovrCloudStorageMetadataHandle obj);
