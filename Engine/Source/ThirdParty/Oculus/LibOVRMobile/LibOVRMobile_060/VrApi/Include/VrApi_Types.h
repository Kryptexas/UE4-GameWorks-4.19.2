...
typedef struct ovrPoseStatef_
{
	...
	double		PredictionInSeconds;	// Seconds this state was predicted ahead.
} ovrPoseStatef;
...
typedef enum
{
	...
	VRAPI_FRAME_OPTION_FIXED_OVERLAY								= 32,
...
typedef enum
{
	VRAPI_FRAME_LAYER_IMAGE_TYPE_2D,					// Simple 2D texture.
	VRAPI_FRAME_LAYER_IMAGE_TYPE_2D_EXTERNAL,			// External 2D texture.
	VRAPI_FRAME_LAYER_IMAGE_TYPE_2D_ARRAY,				// The image is a layer of a texture array.
	VRAPI_FRAME_LAYER_IMAGE_TYPE_2D_ARRAY_FOVEATED,		// The image is a layer of a texture array.
	VRAPI_FRAME_LAYER_IMAGE_TYPE_CUBE,					// Cube map.
	// Special built-in images.
	VRAPI_FRAME_LAYER_IMAGE_TYPE_BLACK,					// Use black image.
	VRAPI_FRAME_LAYER_IMAGE_TYPE_LOADING_ICON			// Use default loading icon image.
} ovrFrameLayerImageType;
...
typedef struct
{
	...
	ovrFrameLayerImage		Images[VRAPI_FRAME_LAYER_EYE_MAX];
